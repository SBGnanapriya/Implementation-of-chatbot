...
file_path = os.path.abspath("C:\Users\ELCOT\Desktop\Implementation of Chatbot Using NLP/intents.json")
...
def main():
    ...
    if choice == "Home":
        ...
        st.write("The goal of this project is to create a chatbot that can understand and respond to user input based on intents. The chatbot is built using Streamlit, a Python library for building interactive web applications.")
        ...
        - Intents: The intent of the user input (e.g. "greeting", "budget", "about","movies")
